...
export type TrackFeatureType = "minable.rock1" | "minable.rock2" | 'minable.MysteryBlock' | 'buyable.item.bronze.shoe' | 'minable.test.voxbucks'; 
...
//broadcast object to inform server info
...
export interface IPlayer{
  ...
  playfabBalance:IPlayer//hold what playfab thinks the balance is 
}
...
export type RemoteBaseCoinRoomConfig={
  items:{
    ...
    enableOnExpireRespawn?:boolean,
    enableOnCollectRespawn?:boolean,
    //below 0 is undefined
    expireTimeInSeconds?:number
    onCollectRespawnTimeInSeconds?:number,
    maxDistanceSpawnRndPosition?:number,
    numCoinsToPlace?:number
