...
export type PlayerServerSideData = {
  ...
  wearables?:WearablesByOwnerData
...
export class PlayerInventoryState extends Schema implements serverStateSpec.PlayerInventoryState {
  @type("number") coinsCollected: number=0;
  @type("number") coinGcCount: number=0;
  ...
  @type("number") container1Count: number=0;
...
export class PlayerState extends Schema implements serverStateSpec.PlayerState {
  ...
  inventory: PlayerInventoryState = new PlayerInventoryState()
