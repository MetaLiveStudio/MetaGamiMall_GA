...
export let smallCardHighlightShape = new GLTFShape(
  modelFolder + "collection_highlight.glb"
);
export let cardClickableShape = new GLTFShape(
  modelFolder + "card_clickable.glb"
);
export let collectionMenuShape = new GLTFShape(
  modelFolder + "collection_menu_bg.glb"
);
...
export let menuTopEventsShape = new GLTFShape(
  modelFolder + "menu_top_events.glb"
);
export let menuTopCrowdShape = new GLTFShape(
  modelFolder + "menu_top_crowd.glb"
);
export let menuTopClassicsShape = new GLTFShape(
  modelFolder + "menu_top_classics.glb"
);
...
export let highlightFrameShape = new GLTFShape(
  modelFolder + "highlight_frame.glb"
);
export let highlightRaysShape = new GLTFShape(
  modelFolder + "highlight_rays.glb"
);
...
export let detailsCardShape = new GLTFShape(
  modelFolder + "wearable_details_card.glb"
);
...
export let scrollInstructionShape = new GLTFShape(
  modelFolder + "scroll_instructions.glb"
);
...
export let uncommonBGShape = new GLTFShape(
  modelFolder + "rarity_bg_uncommon.glb"
);
...
export let legendaryBGShape = new GLTFShape(
  modelFolder + "rarity_bg_legendary.glb"
);
