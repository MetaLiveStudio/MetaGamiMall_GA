  ...
  constructor(
    ...
    switch (style) {
      ...
      case PromptStyles.LIGHTLARGE:
        ...
        setSection(
          this.background,
          resources.backgrounds.promptLargeBackground
        );
        setSection(this.closeIcon, resources.icons.closeD);
      ...
      case PromptStyles.LIGHTSLANTED:
        ...
        setSection(
          this.background,
          resources.backgrounds.promptSlantedBackground
        );
        setSection(this.closeIcon, resources.icons.closeD);
        this.closeIcon.positionX = width ? width / 2 - 25 : 175 + 40;
...
export class CustomPromptSwitch extends Entity {
  ...
  public uncheck(): void {
    this.checked = false;
    if (
      this.style == SwitchStyles.ROUNDGREEN ||
      this.style == SwitchStyles.ROUNDRED
    ) {
...
export class CustomPromptIcon extends Entity {
  ...
  constructor(
    ...
    this.image.sourceLeft =
      section && section.sourceLeft ? section.sourceLeft : 0;
    this.image.sourceTop = section && section.sourceTop ? section.sourceTop : 0;
    this.image.sourceWidth =
      section && section.sourceWidth
        ? section.sourceWidth
        : width
        ? width
        : 128;
    this.image.sourceHeight =
      section && section.sourceHeight
