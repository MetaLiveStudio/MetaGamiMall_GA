...
export const mercedes:CarData = {
    id: "mercedes",
    name: "Mercedes",
    mesh: "models/racing-models/car_mercedes.glb",        
    driverMesh: "models/racing-models/driver.glb",        
    wheelMesh: "models/racing-models/wheel_mercedes.glb",        
...
export const mercedesAltTest:CarData = {
    ...
    mesh: "models/racing-models/car_mercedes_test.glb",        
    driverMesh: "models/racing-models/driver_test.glb",        
    wheelMesh: "models/racing-models/wheel_mercedes_test.glb",        
    frontWheelR: new Vector3( 0.18,0.07,0.38),
    frontWheelL: new Vector3(-0.18,0.07,0.38),
    rearWheelR: new Vector3(  0.18,0.07,-0.23),
    rearWheelL: new Vector3( -0.18,0.07,-0.23),
...
export const MdPmercedes:CarData = {
    id: "mdp",
    name: "MDP",
    mesh: "models/racing-models/empty-model.glb",  
    driverMesh: "models/racing-models/00LilDoge.glb",                     
    wheelMesh: "models/racing-models/empty-model.glb",         
    frontWheelR: new Vector3( 0.18, 0.07, 0.38),
    frontWheelL: new Vector3(-0.18, 0.07, 0.38),
    rearWheelR: new Vector3(  0.18, 0.07, -0.23),
    rearWheelL: new Vector3( -0.18, 0.07, -0.23),
    exhaustScale: new Vector3(0, 0, 0),
    exhaustPos: new Vector3(0.12, 0.05, -0.45),   
    driverPos: new Vector3(-1.2, 0.1, -0.1),   
    driverScale: new Vector3(0.5, 0.5, 0.5)
};
...
export const roadster:CarData = {
    ...
    mesh: "models/racing-models/car_roadster_body.glb",        
    driverMesh: "models/racing-models/driver_test.glb",        
    wheelMesh: "models/racing-models/car_roadster_wheel.glb",        
