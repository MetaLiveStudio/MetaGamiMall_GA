...
export class SoundPoolMgr {
    boost:SoundPool = new SoundPool( "car.boost",3,{audioClipUrl:'sounds/racing/boostClip2.mp3',clipLen:1500,replayCooldown:200,volume:.7} );
    trap:SoundPool = new SoundPool( "car.trap",3,{audioClipUrl:'sounds/racing/trapClip.mp3',clipLen:1500,replayCooldown:200,volume:.8} );
    skid:SoundPool = new SoundPool( "car.skid",2,{audioClipUrl:'sounds/racing/skid.mp3',clipLen:1500,replayCooldown:1000,volume:.4} );
    skidChirp:SoundPool = new SoundPool( "car.skid.chirp",2,{audioClipUrl:'sounds/racing/skid-tire-chirp.mp3',clipLen:900,replayCooldown:900,volume:.05} );

    skidChirp1:SoundPool = new SoundPool( "car.skid.chirp.1",1,{audioClipUrl:'sounds/racing/Skid_01.mp3',clipLen:3000,replayCooldown:900,volume:.55} );
    skidChirp2:SoundPool = new SoundPool( "car.skid.chirp.2",1,{audioClipUrl:'sounds/racing/Skid_02.mp3',clipLen:3000,replayCooldown:900,volume:.55} );
    skidChirp3:SoundPool = new SoundPool( "car.skid.chirp.3",1,{audioClipUrl:'sounds/racing/Skid_03.mp3',clipLen:3000,replayCooldown:900,volume:.55} );
    skidChirp4:SoundPool = new SoundPool( "car.skid.chirp.4",1,{audioClipUrl:'sounds/racing/Skid_04.mp3',clipLen:3000,replayCooldown:900,volume:.55} );

    raceCountdown:SoundPool = new SoundPool( "race.countdown",1,{audioClipUrl:'sounds/racing/raceCountdown.mp3',clipLen:6000,replayCooldown:6000,volume:.8} );
