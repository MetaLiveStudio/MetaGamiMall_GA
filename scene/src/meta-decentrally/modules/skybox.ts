...
export class SkyBoxControl{
 ...
 skyBoxTopTexture:Texture
  ...
  constructor(){
    this.fogSphereShape =    new GLTFShape('models/racing-models/fogSphere.glb')
    this.skyBoxTexture = new Texture('images/racing-textures/skybox.png', {samplingMode: 0, wrap: 1})
    this.skyBoxTopTexture = new Texture('images/racing-textures/skyboxTop.png', {samplingMode: 2})
