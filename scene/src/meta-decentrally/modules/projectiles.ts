...
let fireClip = new AudioClip('sounds/racing/rocket_fire.mp3')
let explosionClip = new AudioClip('sounds/racing/explosion.mp3')


 let rocketShape = new GLTFShape('models/racing-models/rocket_projectile.glb')
 let explosionShape = new GLTFShape('models/racing-models/explosion.glb')
...
export class Projectile extends Entity {
  ...
  class Explosion extends Entity{
    ...
    constructor(_position:Vector3, _rotation:Quaternion){
      ...
      this.addComponent(new GLTFShape('models/racing-models/explosion.glb'))
