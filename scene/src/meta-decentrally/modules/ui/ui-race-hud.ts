...
//let uiAtlasTexture = new Texture('images/racing-textures/ui_atlas.png', {samplingMode: 1})
...
topRightContainer.positionY = SHIFT_Y
topRightContainer.positionX = -30
...
quitRaceBtn.positionY = -100 //+ SHIFT_Y //-70
...
howToPlayBtn.positionY = -70 //+ SHIFT_Y //-100
howToPlayBtn.height = parseInt(howToPlayBtn.height + "")/2

const lapTimeArray:UIText[]=[]
for(let x=0;x<3;x++){
