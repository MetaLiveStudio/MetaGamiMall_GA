...
const INVISIBLE_MATERIAL_texture = new Texture('images/racing-textures/transparent-texture.png')
...
let enemyMarkerTexture = new Texture('images/racing-textures/enemy_marker.png', {samplingMode: 2})
