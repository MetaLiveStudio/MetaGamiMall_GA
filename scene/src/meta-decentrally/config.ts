...
const DEFAULT_ENV = BASE_CONFIG.DEFAULT_ENV

const GAME_OTHER_ROOM_DISCONNECT_TIMER_WAIT_TIME = 4000
const PLAYFAB_ENABLED = BASE_CONFIG.PLAYFAB_ENABLED
const PLAYFAB_TITLE_ID: Record<string, string> = BASE_CONFIG.PLAYFAB_TITLE_ID

const COLYSEUS_ENDPOINT_URL: Record<string, string> = BASE_CONFIG.COLYSEUS_ENDPOINT_URL
...
export class Config{
  ...
  DEBUG_SHOW_CONNECTION_INFO = BASE_CONFIG.CONFIG.SHOW_CONNECTION_DEBUG_INFO
  DEBUG_SHOW_PLAYER_LOGIN_INFO = BASE_CONFIG.CONFIG.SHOW_PLAYER_DEBUG_INFO
  TEST_CONTROLS_ENABLE =  BASE_CONFIG.CONFIG.TEST_CONTROLS_ENABLE
  TEST_CONTROLS_DEFAULT_EXPANDED = false //if test controls expanded by default

  ADMINS =  BASE_CONFIG.CONFIG.ADMINS
  ...
  AUTO_LOGIN_ENABLED = BASE_CONFIG.CONFIG.AUTO_LOGIN_ENABLED
  LOGIN_FLOW_TYPE = BASE_CONFIG.CONFIG.LOGIN_FLOW_TYPE
  ...
  GAME_OTHER_ROOM_DISCONNECT_TIMER_WAIT_TIME = GAME_OTHER_ROOM_DISCONNECT_TIMER_WAIT_TIME//in milliseconds. how long to wait for other room disconnect to finalize
