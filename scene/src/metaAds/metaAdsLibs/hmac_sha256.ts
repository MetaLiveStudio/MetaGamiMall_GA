...
function fillBuffer (buffer: Uint8Array, hmac: HMAC, info: Uint8Array, counter: Uint8Array): void {
  const num = counter[0]
  if (num === 0) {
...
const hkdfSalt = new Uint8Array(digestLength)
export function hkdf (key: Uint8Array, salt: Uint8Array = hkdfSalt, info: Uint8Array, length: number = 32): Uint8Array {
