...
export let lightTheme = new Texture(
  "https://decentraland.org/images/ui/light-atlas-v3.png"
);
export let darkTheme = new Texture(
  "https://decentraland.org/images/ui/dark-atlas-v3.png"
);

export let bubblesTexture = new Texture(
...
export function setUVSection(
  ...
  if (section.sourceTop && section.sourceLeft) {
    setUVs(
      plane,
      new Vector2(
