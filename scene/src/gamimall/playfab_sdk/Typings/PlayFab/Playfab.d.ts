/// xreference path="PlayFabAdminApi.d.ts" />
/// <reference path="PlayFabClientApi.d.ts" />
/// xreference path="PlayFabMatchmakerApi.d.ts" />
/// xreference path="PlayFabServerApi.d.ts" />
...
/// xreference path="PlayFabInsightsApi.d.ts" />
/// <reference path="PlayFabGroupsApi.d.ts" />
/// <reference path="PlayFabLocalizationApi.d.ts" />
/// xreference path="PlayFabMultiplayerApi.d.ts" />
