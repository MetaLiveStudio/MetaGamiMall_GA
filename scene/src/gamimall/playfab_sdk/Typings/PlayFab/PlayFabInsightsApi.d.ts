...
declare module PlayFabInsightsModule {
  export interface IPlayFabInsights {
    ...
    GetDetails(
      ...
      callback: PlayFabModule.ApiCallback<PlayFabInsightsModels.InsightsGetDetailsResponse>,
      customData?: any,
    ...
    GetLimits(
      request: PlayFabInsightsModels.InsightsEmptyRequest,
      callback: PlayFabModule.ApiCallback<PlayFabInsightsModels.InsightsGetLimitsResponse>,
      customData?: any,
      extraHeaders?: { [key: string]: string }
    ): void;
    /**
    ...
    GetOperationStatus(
      ...
      callback: PlayFabModule.ApiCallback<PlayFabInsightsModels.InsightsGetOperationStatusResponse>,
      customData?: any,
      extraHeaders?: { [key: string]: string }
    ): void;
    /**
    ...
    GetPendingOperations(
      ...
      callback: PlayFabModule.ApiCallback<PlayFabInsightsModels.InsightsGetPendingOperationsResponse>,
      customData?: any,
      extraHeaders?: { [key: string]: string }
    ): void;
    /**
    ...
    SetPerformance(
      ...
      callback: PlayFabModule.ApiCallback<PlayFabInsightsModels.InsightsOperationResponse>,
      customData?: any,
      extraHeaders?: { [key: string]: string }
    ): void;
    /**
