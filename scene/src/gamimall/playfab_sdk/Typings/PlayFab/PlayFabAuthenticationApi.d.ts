...
declare module PlayFabAuthenticationModule {
  export interface IPlayFabAuthentication {
     ...
     */
    GetEntityToken(
      request: PlayFabAuthenticationModels.GetEntityTokenRequest,
      callback: PlayFabModule.ApiCallback<PlayFabAuthenticationModels.GetEntityTokenResponse>,
      customData?: any,
     ...
     */
    ValidateEntityToken(
      request: PlayFabAuthenticationModels.ValidateEntityTokenRequest,
      callback: PlayFabModule.ApiCallback<PlayFabAuthenticationModels.ValidateEntityTokenResponse>,
      customData?: any,
      extraHeaders?: { [key: string]: string }
    ): void;
  }
...
declare module PlayFabAuthenticationModels {
  ...
  type IdentifiedDeviceType = "Unknown" | "XboxOne" | "Scarlett";
