...
declare module PlayFabExperimentationModule {
  export interface IPlayFabExperimentation {
    ...
    CreateExclusionGroup(
      ...
      callback: PlayFabModule.ApiCallback<PlayFabExperimentationModels.CreateExclusionGroupResult>,
      customData?: any,
    ...
    CreateExperiment(
      ...
      callback: PlayFabModule.ApiCallback<PlayFabExperimentationModels.CreateExperimentResult>,
      customData?: any,
      extraHeaders?: { [key: string]: string }
    ): void;
    /**
    ...
    DeleteExclusionGroup(
      ...
      callback: PlayFabModule.ApiCallback<PlayFabExperimentationModels.EmptyResponse>,
      customData?: any,
      extraHeaders?: { [key: string]: string }
    ): void;
    /**
    ...
    GetExclusionGroups(
      ...
      callback: PlayFabModule.ApiCallback<PlayFabExperimentationModels.GetExclusionGroupsResult>,
      customData?: any,
      extraHeaders?: { [key: string]: string }
    ): void;
    /**
    ...
    GetExclusionGroupTraffic(
      ...
      callback: PlayFabModule.ApiCallback<PlayFabExperimentationModels.GetExclusionGroupTrafficResult>,
      customData?: any,
      extraHeaders?: { [key: string]: string }
    ): void;
    /**
    ...
    GetExperiments(
      ...
      callback: PlayFabModule.ApiCallback<PlayFabExperimentationModels.GetExperimentsResult>,
      customData?: any,
      extraHeaders?: { [key: string]: string }
    ): void;
    /**
    ...
    GetLatestScorecard(
      ...
      callback: PlayFabModule.ApiCallback<PlayFabExperimentationModels.GetLatestScorecardResult>,
      customData?: any,
      extraHeaders?: { [key: string]: string }
    ): void;
    /**
    ...
    GetTreatmentAssignment(
      ...
      callback: PlayFabModule.ApiCallback<PlayFabExperimentationModels.GetTreatmentAssignmentResult>,
      customData?: any,
      extraHeaders?: { [key: string]: string }
    ): void;
    /**
