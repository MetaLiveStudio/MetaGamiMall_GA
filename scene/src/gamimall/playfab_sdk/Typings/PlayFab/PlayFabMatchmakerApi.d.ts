...
declare module PlayFabMatchmakerModule {
  export interface IPlayFabMatchmaker {
     ...
     */
    AuthUser(
      request: PlayFabMatchmakerModels.AuthUserRequest,
      callback: PlayFabModule.ApiCallback<PlayFabMatchmakerModels.AuthUserResponse>,
      customData?: any,
     ...
     */
    PlayerJoined(
      request: PlayFabMatchmakerModels.PlayerJoinedRequest,
      callback: PlayFabModule.ApiCallback<PlayFabMatchmakerModels.PlayerJoinedResponse>,
      customData?: any,
      extraHeaders?: { [key: string]: string }
    ): void;
    /**
     ...
     */
    PlayerLeft(
      request: PlayFabMatchmakerModels.PlayerLeftRequest,
      callback: PlayFabModule.ApiCallback<PlayFabMatchmakerModels.PlayerLeftResponse>,
      customData?: any,
      extraHeaders?: { [key: string]: string }
    ): void;
    /**
     ...
     */
    UserInfo(
      request: PlayFabMatchmakerModels.UserInfoRequest,
      callback: PlayFabModule.ApiCallback<PlayFabMatchmakerModels.UserInfoResponse>,
      customData?: any,
      extraHeaders?: { [key: string]: string }
    ): void;
  }
