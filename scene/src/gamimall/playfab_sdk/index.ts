...
let SpecificRevision: string | undefined = undefined;
const setSpecificRevision = (specificRevision: string) => {
  if (!specificRevision) return;
  SpecificRevision = specificRevision;
};
const c = (resolve: (result: any) => void, reject: (reason: any) => void) => {
...
const UpdateUserTitleDisplayName = (
