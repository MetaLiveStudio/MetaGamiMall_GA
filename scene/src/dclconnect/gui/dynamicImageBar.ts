...
export class DynamicImageBar extends DynamicImage {
  ...
  constructor(
    ...
    this.startPositionX = parseInt(image.positionX + ""); //force string to parse it to number
    this.startPositionY = parseInt(image.positionY + "");
  ...
  setValue(value: number, duration: number = 2) {
    ...
    switch (this.orientation) {
      case DynamicBarOrientation.CENTER_HORIZONTAL_ALIGNED:
        ...
        this.moveSourceTo(
          new Vector2(
            this.startSourceWidth / 2 - percentWidth / 2 + this.startSourceLeft,
            this.startSourceTop
          ),
          duration
        );
        this.resizeSourceTo(
          new Vector2(percentWidth, this.startSourceHeight),
          duration
        );
        this.resizeTo(
          new Vector2(percentWidth, this.startSourceHeight),
      ...
      case DynamicBarOrientation.LEFT_ALIGNED:
        percentWidth = (this.startSourceWidth / 100) * value;
        this.moveSourceTo(
          new Vector2(this.startSourceLeft, this.startSourceTop),
          duration
        );
        this.resizeSourceTo(
          new Vector2(percentWidth, this.startSourceHeight),
      ...
      case DynamicBarOrientation.RIGHT_ALIGNED:
        ...
        this.moveSourceTo(
          new Vector2(
            this.startSourceLeft + (this.startSourceWidth - percentWidth),
            this.startSourceTop
          ),
          duration
        );
      ...
      case DynamicBarOrientation.VALIGN_CENTER_LEFT_ALIGNED:
        ...
        this.moveTo(
          new Vector2(
            this.startPositionX -
              (this.startSourceWidth / 2 - percentWidth / 2),
            this.startPositionY
          ),
          2
        );
      ...
      case DynamicBarOrientation.BOTTOM_ALIGNED:
        ...
        this.moveSourceTo(
          new Vector2(
            this.startSourceLeft,
            this.startSourceTop + (this.startSourceHeight - percentHeight)
          ),
          duration
        );
        this.resizeSourceTo(
          new Vector2(this.startSourceWidth, percentHeight),
          duration
        );
        this.resizeTo(
          new Vector2(this.startSourceWidth, percentHeight),
      ...
      case DynamicBarOrientation.TOP_ALIGNED:
        ...
        this.resizeSourceTo(
          new Vector2(
            this.startSourceLeft,
            this.startSourceLeft + percentHeight
          ),
          duration
        );
        this.resizeTo(
