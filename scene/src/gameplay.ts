...
import {  CONNECTION_EVENT_REGISTRY, connect, disconnect, reconnect, showConnectingEnded } from "./gamimall/connection";
...
import * as clientState from "./gamimall/state/client-state-spec";
import * as serverStateSpec from "./gamimall/state/MyRoomStateSpec";
import { REGISTRY } from './registry';
import { COIN_GAME_FEATURE_DEF } from './gamimall/mining/setupMinables';
import { minableController } from './gamimall/mining/minables';
...
export const onJoinActions = (
  ...
  room.state.players.onAdd = (player: any, sessionId: string) => {
    ...
    const coinListeners=[
      ...
      */
      {name:"coinVbCount",fn:(val:number)=>{GAME_STATE.setGameCoinVBValue(val)}}
    ]
