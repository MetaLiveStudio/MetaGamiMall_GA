...
export default class Button implements IScript<Props> {
  ...
  material: BasicMaterial = CommonResources.RESOURCES.materials.transparent;

  init() {
    this.material = CommonResources.RESOURCES.materials.transparent;
  }
